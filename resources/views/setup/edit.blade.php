@extends('layouts.app')
@section('title', 'Edit Setup - Company Configuration')
...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            <div class="pt-5">
                <div class="">
                    <h1 style="font-size: 36px; font-weight: bold; color: #015377;">Edit Company Setup</h1>
                    <p class="text-muted">Update your company information and system settings</p>
                            ...
                            <form action="{{ route('setup.update', $setup->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="company_phone" 
                                                   name="company_phone" 
                                                   value="{{ old('company_phone', $setup->company_phone) }}" 
                                                   required>
                                            @error('company_phone')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" 
                                                   ...
                                                   value="{{ old('start_entry_period', $setup->start_entry_period->format('Y-m-d')) }}" 
                                                   required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" 
                                                   ...
                                                   id="company_email" 
                                                   name="company_email" 
                                                   value="{{ old('company_email', $setup->company_email) }}" 
                                                   required>
                                            @error('company_email')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('company_address') is-invalid @enderror" 
                                              ...
                                              rows="3" 
                                              required>{{ old('company_address', $setup->company_address) }}</textarea>
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fe fe-save"></i> Update Setup
                                    </button>
                                </div>
                            </form>
                        </div>
