...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <h4>Add New Operation Export</h4>
            <!-- PAGE-HEADER END -->
            @if ($errors->any())
            ...
            @endif
        <form action="{{ route('operation.export.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="mbl" id="mbl" value="{{ old('mbl') }}" placeholder="fill the text..">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label">HBL</label>
                                                <input type="text" class="form-control" name="hbl" id="hbl" value="{{ old('hbl') }}" placeholder="fill the text..">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label">Chargeable Weight</label>
                                                <input type="number" step="0.01" class="form-control" name="chargeable_weight" id="chargeable_weight" value="{{ old('chargeable_weight') }}" placeholder="fill the number..">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="form-group">
                                            <label class="form-label">Transit Via</label>
                                                <input type="text" name="transit[0]" class="form-control mb-4" placeholder="Fill the text">
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="form-group">
