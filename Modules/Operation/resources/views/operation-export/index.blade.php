            ...
            <div class="main-container container-fluid">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <form action="{{ route('operation.export.index') }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table text-nowrap text-md-nowrap mb-0">
                                        ...
                                        <tbody>
                                            @forelse ($operationExports as $key => $data)
                                                <tr>
                                                    <td>{{ $operationExports->firstItem() + $key }}</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="g-2">
                                                            <a href="{{ route('operation.export.show', $data->id) }}"
                                                            ...
                                                            <a href="{{ route('operation.export.edit', $data->id) }}"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('operation.export.update-progress') }}" method="POST"
                    ...
                    <form id="formCreateProgress" style="display: none"
                        action="{{ route('operation.export.store-progress') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="operation_export_id" id="operation_export_id">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-8">
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '#btn-progress', function() {
                ...
                $.ajax({
                    ...
                    url: '{{ route('operation.export.create-progress') }}',
                        ...
                        $.each(response.data, function(key, item) {
                            ...
                            let content = `<div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="g-2">
                                            <form action="{{ route('operation.export.delete-progress', ':id_progress') }}" method="POST" class="d-inline" onclick="return confirm('Are you sure wants to delete this item');">
                                                @csrf
                                                @method('delete')
        ...
        function deleteDocument(id) {
            if(confirm('Are you sure want to delete this item?')) {
                $.ajax({
                    ...
                    type: 'DELETE',
                    dataType: 'json',
                    url: "{{ route('operation.export.delete-progress-document', ':id') }}".replace(':id', id),
                    success: function () {
                        location.reload()
                    }
                })
