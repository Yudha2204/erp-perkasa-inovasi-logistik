...
class TransactionsKasInController extends Controller
{
    /**
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $exists = NoTransactionsKasIn::where('template', $template)->exists();
        if ($exists) {
        ...
        NoTransactionsKasIn::create($data);
    ...
    {
        $transactions = NoTransactionsKasIn::findOrFail($id);
        $transactions->delete();
