...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        <form action="{{ route('finance.kas.pembayaran.update', $head->id) }}" method="POST" enctype="multipart/form-data" name="dynamic-form">
            @csrf
            @method('PUT')
            <!-- PAGE-HEADER -->
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="date" id="date" value="{{ $head->date_kas_out }}">
                                </div>
                            </div>
                          </div>
                          <div class="row">
