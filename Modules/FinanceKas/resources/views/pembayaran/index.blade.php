            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="d-flex d-inline">
                        ...
                        <a class="btn btn-primary" href="{{ route('finance.kas.pembayaran.create') }}"><i
                                ...
                                <table class="table text-nowrap text-md-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $data->date_kas_out)->format('d/m/Y') }}</td>
                                            ...
                                            <td>
                                                <div class="dropdown" style="position: absolute; display: inline-block;">
                                                    ...
                                                    <div class="dropdown-menu" style="min-width: 7rem; z-index: 999999999;">
                                                        <a href="{{ route('finance.kas.pembayaran.show', $data->id) }}" class="btn text-purple btn-sm dropdown-item"><span class="fe fe-eye fs-14"></span> Detail</a>
                                                        <a href="{{ route('finance.kas.pembayaran.edit', $data->id) }}" class="btn text-warning btn-sm dropdown-item"><span class="fe fe-edit fs-14"></span> Edit</a>
                                                        <a href="{{ route('finance.kas.pembayaran.jurnal', $data->id) }}" class="btn text-success btn-sm dropdown-item">
                                                            <span class="fe fe-edit fs-14"></span> Journal
                                                        </a>

                                                        <!-- delete -->
                                                        <form action="{{ route('finance.kas.pembayaran.destroy', $data->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
