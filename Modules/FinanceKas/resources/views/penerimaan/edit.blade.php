...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        <form action="{{ route('finance.kas.penerimaan.update', $head->id) }}" method="POST" enctype="multipart/form-data" name="dynamic-form">
            @csrf
            @method('PUT')
            <!-- PAGE-HEADER -->
                            ...
                            <div class="row">
                                        ...
                                        <div class="d-flex d-inline">
                                            <select class="form-control select2 form-select"
                                                ...
                                                @foreach ($contact as $c)
                                                    <option value="{{ $c->id }}" {{ $c->id === $head->contact->id ? "selected" : "" }}>{{ $c->customer_name }}</option>   
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 form-select"
                                            ...
                                            @foreach ($accounts as $a)
                                                <option value="{{ $a->id }}" {{ $a->id === $head->account->id ? "selected" : "" }}>{{ $a->account_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date" id="date" value="{{ $head->date_kas_in }}">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="description" id="description" placeholder="Desc" value="{{ $head->description }}"/>
                                    </div>
                              </div>
                          </div>
                          <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 form-select"
                                            ...
                                            @foreach ($marketing as $jo)
                                                <option value="{{ $jo->id }}:{{ $jo->source }}" {{ $jo->id === $head->job_order_id && $jo->source === $head->source ? "selected" : "" }}>{{ $jo->job_order_id }} - {{ $jo->source }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                              ...
                              <table class="table">
                                  ...
                                  <tbody id="form-container">
                                    ...
                                    <tr class="form-wrapper group-form">
                                        ...
                                        <td>
                                            <input type="text" class="form-control description-input" name="desc_detail" placeholder="Desc..." value="{{ $data->description }}" onchange="toUpdate(this)"/>
                                            <label class="form-label remark-input">Remark</label>
                                            <input type="text" class="form-control remark-input mt-2" name="remark_detail" placeholder="Text..." value="{{ $data->remark }}" onchange="toUpdate(this)"/>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <select class="form-control select2 form-select"
                                                    data-placeholder="Choose One" name="account_detail_id" onchange="toUpdate(this)">
                                                    <option label="Choose One"></option>
                                                    @foreach ($accounts as $a)
                                                    <option value="{{ $a->id }}" {{ $a->id === $data->account->id ? "selected" : "" }}>{{ $a->account_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" placeholder="Nominal" name="price_detail" onchange="calculate(); toUpdate(this)" value="{{ number_format($data->total, 2, '.',',') }}"/>
                                        </td>
                                        <td>
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <input name="operator" hidden value="{{ $data->id }}:nothing">
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
                            ...
                            <div class="panel-body tabs-menu-body mt-3">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab30">
                                        <form action="{{ route('finance.kas.transaction-kas-in.store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
...
@push('scripts')
    ...
    <script>
        ...
        function getAccountDetail(isChange) {
        ...
        document.getElementById('add-form').addEventListener('click', function() {
            ...
            <td>
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn delete-row" onclick="deleteList(this)"><i class="fa fa-trash text-danger delete-form"></i></button>
                    <input name="operator" hidden value="0:create"
                </div>
            </td>
            `;
        ...
        function toUpdate(element) {
            ...
            element.closest('tr').querySelector('input[name="operator"]').value = `${id}:update`
        }
