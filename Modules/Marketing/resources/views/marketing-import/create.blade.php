...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        <form action="{{ route('marketing.import.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @if ($marketingImportId)
                <input type="hidden" name="marketing_import_id" value="{{ $marketingImportId }}">
            @endif
            <!-- PAGE-HEADER -->
            <div class="page-header mb-0">
                <h1>Marketing</h1>
            </div>
            <h4>Add New Marketing Import</h4>
            <!-- PAGE-HEADER END -->
