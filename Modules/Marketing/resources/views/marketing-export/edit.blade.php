...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        <form action="{{ route('marketing.export.update', $marketingExport->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <!-- PAGE-HEADER -->
                        ...
                        <div class="row">
                            <div class="col-10 mx-auto form-group">
                                ...
                                <select name="expedition"   class="form-control form-select" data-bs-placeholder="Select expedition">
                                    <option value="1" {{ $marketingExport->expedition == 1 ? 'selected' : '' }}>Domestik</option>
                                    <option value="2" {{ $marketingExport->expedition == 2 ? 'selected' : '' }}>International</option>
                                </select>
                            </div>
                            <div class="col-10 mx-auto form-group">
                                ...
                                <select class="form-control select2 form-select"
                                    ...
                                    <option value="1" {{ $marketingExport->transportation == 1 ? 'selected' : '' }}>Air Freight</option>
                                    <option value="2" {{ $marketingExport->transportation == 2 ? 'selected' : '' }}>Sea Freight</option>
                                    <option value="3" {{ $marketingExport->transportation == 3 ? 'selected' : '' }}>Land Trucking</option>
                                </select>
                            </div>
                            <div class="col-10 mx-auto form-group">
                                <div id="transportation_desc_before" style="display: block">
                                    @if ($marketingExport->transportation == 1)
                                        <label class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input"
                                                name="transportation_desc" value="Hand Carry" {{ $marketingExport->transportation_desc == 'Hand Carry' ? 'checked' : '' }}>
                                            <span class="custom-control-label">Hand Carry</span>
                                        </label>
                                        <label class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input"
                                                name="transportation_desc" value="Express" {{ $marketingExport->transportation_desc == 'Express' ? 'checked' : '' }}>
                                            <span class="custom-control-label">Express</span>
                                        </label>
                                        <label class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input"
                                                name="transportation_desc" value="Regular" {{ $marketingExport->transportation_desc == 'Regular' ? 'checked' : '' }}>
                                            <span class="custom-control-label">Regular</span>
                                        </label>
                                    @elseif ($marketingExport->transportation == 2)
                                        <label class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input"
                                                name="transportation_desc" value="FCL" {{ $marketingExport->transportation_desc == 'FCL' ? 'checked' : '' }}>
                                            <span class="custom-control-label">FCL</span>
                                        </label>
                                        <label class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input"
                                                name="transportation_desc" value="LCL" {{ $marketingExport->transportation_desc == 'LCL' ? 'checked' : '' }}>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="row">
                            <div class="col-6 mx-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="no_po" id="no_po" value="{{ $marketingExport->no_po }}"  >
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="form-group">
                                    <label for="" class="form-label">Commodity/Description</label>
                                    <textarea class="form-control mb-4" placeholder="Description" rows="5" name="description">{{ $marketingExport->description }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            @if ($marketingExport->quotation)
                                {{-- kalau sudah ada quotation, maka edit dan hapus --}}
                                <div class="col-6 mx-3">
                                    <div class="form-group">
                                        <label class="form-label">No Quotation</label>
                                        <input type="text" class="form-control" name="no_cipl" id="no_cipl" value="{{ $marketingExport->quotation->quotation_no }}" disabled >
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex d-inline">
                                            <input type="text" class="form-control" name="no_cipl" id="no_cipl" value="{{ $marketingExport->quotation->sales_value}}" disabled >
                                            <a href="{{ route('marketing.export.edit-quotation', $marketingExport->id) }}" class="btn text-warning btn-sm"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="no_cipl" id="no_cipl" value="{{ $marketingExport->no_cipl }}" placeholder="fill the text.."  >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">Total Weight</label>
                                        <input type="number" class="form-control" name="total_weight" id="total_weight" value="{{ $marketingExport->total_weight }}" placeholder="fill the text.."  >
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label">Total Volume</label>
                                    <input type="text" id="total_volume_edit" name="total_volume_edit" value="{{ $marketingExport->total_volume }}" class="form-control" readonly>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="" class="form-label" style="color: white">.</label>
                                        <input type="text" class="form-control" name="freetext_volume" value="{{ $marketingExport->freetext_volume }}" placeholder="free text" id="freetext_volume">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row my-5">
                                    ...
                                    @if ($marketingExport->dimensions->count() > 0)
                                        <div class="table-responsive">
                                            <table class="table table-bordered text-nowrap w-full datetimetable" id="dimensionTable"
                                                ...
                                                <tbody>
                                                    @foreach ($marketingExport->dimensions as $dimension)
                                                        <tr class="form-control-sm theDimensions{{ $loop->iteration }}">
                                                            ...
                                                            @php
                                                                $heightDivInput_measure = $dimension->input_measure == 0 ? 0 : $dimension->height / $dimension->input_measure;
                                                                $total = $dimension->length * $dimension->width * $heightDivInput_measure * $dimension->qty;
                            ...
                            <div class="row">        
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="origin" id="origin" value="{{ $marketingExport->origin }}" placeholder="fill the text.."  >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">Destination</label>
                                        <input type="text" class="form-control" name="destination" id="destination" value="{{ $marketingExport->destination}}"  placeholder="fill the text.."  >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">Shipper</label>
                                        <input type="text" class="form-control" name="shipper" id="shipper" value="{{ $marketingExport->shipper}}" placeholder="fill the text.."  >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">Consignee</label>
                                        <input type="text" class="form-control" name="consignee" id="consignee" value="{{ $marketingExport->consignee}}"  placeholder="fill the text.."  >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">Pickup Address</label>
                                        <input type="text" class="form-control" name="pickup_address" id="pickup_address" value="{{ $marketingExport->pickup_address}}"  placeholder="fill the text.."  >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">Delivery Address</label>
                                        <input type="text" class="form-control" name="delivery_address" id="delivery_address" value="{{ $marketingExport->delivery_address}}"  placeholder="fill the text.."  >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        @if ($marketingExport->documents->count() > 0)
                                            @foreach ($marketingExport->documents as $file)
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-4" name="remark" placeholder="Fill the text"
                                            rows="4">{{ $marketingExport->remark }}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-controls-stacked">
                                            <label class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" name="status"
                                                    value="1" {{ $marketingExport->status == '1' ? 'checked' : '' }} >
                                                <span class="custom-control-label">Hold</span>
                                            </label>
                                            <label class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" name="status"
                                                    value="2" {{ $marketingExport->status == '2' ? 'checked' : '' }} >
...
{{-- delete quotation --}}
@if ($marketingExport->quotation)
<form id="delete-quotation" action="{{route('marketing.export.delete-quotation')}}" style="display: none;" method="POST">
    @csrf
    @method('POST')
    <input type="hidden" name="quotation_id" value="{{ $marketingExport->quotation->id }}">
</form>
@endif

{{-- delete document --}}
@if ($marketingExport->documents->count() > 0)
<form id="delete-document" action="{{route('marketing.export.delete-document')}}" style="display: none;" method="POST">
    @csrf
    @method('POST')
                                ...
                                <div class="panel-body tabs-menu-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab1edit">
                                            ...
                                            <div class="row input_fields_wrap_new edit">
...
{{-- create quotation --}}
<form id="create-quotation" action="{{route('marketing.export.create-quotation')}}" style="display: none;">
