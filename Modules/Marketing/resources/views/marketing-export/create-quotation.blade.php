...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        @endif
        <!-- PAGE-HEADER END -->
        <form action="{{ route('marketing.export.store-quotation') }}" method="post">
            @csrf
            @if ($dataMarketingExport)
                <input type="hidden" name="marketing_export_id" value="{{ $dataMarketingExport->id }}">
            @endif
                <!-- ROW-1 -->
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                                ...
                                                @if ($dataMarketingExport)
                                                    <select class="form-control select2 form-select"
                                                        ...
                                                        @if (in_array(1, json_decode($c->type)))
                                                            <option value="{{ $c->id }}" {{ $c->id == $dataMarketingExport->contact_id ? 'selected' : '' }}>{{ $c->customer_name }}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                @else
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" id="phone_number" type="number" @if ($dataMarketingExport)
                                                value="{{ $dataMarketingExport->contact->phone_number }}"
                                            @endif disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" id="company_address" type="text" @if ($dataMarketingExport)
                                            value="{{ $dataMarketingExport->contact->address }}"
                                        @endif disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" id="company_name" type="text" @if ($dataMarketingExport)
                                            value="{{ $dataMarketingExport->contact->company_name }}"
                                        @endif disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="term-payment-class">
                                                <input class="form-control mb-4" id="payment_term[0]" type="text" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" id="get_customer_id" type="text" @if ($dataMarketingExport)
                                            value="{{ $dataMarketingExport->contact->customer_id }}"
                                        @endif disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" id="origin" type="text" @if ($dataMarketingExport)
                                            value="{{ $dataMarketingExport->origin }}"
                                        @endif disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" id="destination" type="text" @if ($dataMarketingExport)
                                            value="{{ $dataMarketingExport->destination }}"
                                        @endif disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" id="shipper" type="text" @if ($dataMarketingExport)
                                            value="{{ $dataMarketingExport->shipper }}"
                                        @endif readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" id="consignee" type="text" @if ($dataMarketingExport)
                                            value="{{ $dataMarketingExport->consignee }}" 
                                        @endif readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" name="total_weight" type="text" @if ($dataMarketingExport)
                                            value="{{ $dataMarketingExport->total_weight }}" 
                                        @endif readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4" name="total_volume" type="text" @if ($dataMarketingExport)
                                            value="{{ $dataMarketingExport->total_volume }}" 
                                        @endif readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
