...
use Modules\Process\App\Services\FiscalPeriodService;
...
class FiscalPeriodController extends Controller
{
    ...
    public function __construct(FiscalPeriodService $fiscalPeriodService)
    {
        ...
        $this->middleware('permission:view-fiscal-period@process', ['only' => ['index', 'status', 'list', 'getAvailablePeriods', 'show']]);
        $this->middleware('permission:manage-fiscal-period@process', ['only' => ['open', 'close', 'bulkOpen', 'bulkClose', 'updateNotes', 'create', 'store', 'edit', 'update', 'destroy']]);
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('process::fiscal-period.crud.index', compact('fiscalPeriods'));
    }
    ...
    {
        return view('process::fiscal-period.crud.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('process.fiscal-period.crud.index')
    ...
    public function show($id)
    {
        ...
        return view('process::fiscal-period.crud.show', compact('fiscalPeriod'));
    }
    ...
    {
        $fiscalPeriod = FiscalPeriod::findOrFail($id);
        return view('process::fiscal-period.crud.edit', compact('fiscalPeriod'));
    }
    ...
    {
        return view('process::fiscal-period.index');
    }
