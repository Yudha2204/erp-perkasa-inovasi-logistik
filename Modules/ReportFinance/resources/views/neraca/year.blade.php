                ...
                <div class="row" style="background-color: white; padding-top: 50px; padding-bottom: 50px;" id="headerPrint">
                    <div class="col-xl-12">
                       <div class="w-full d-flex justify-content-center align-items-center flex-column">
                            ...
                            <p style="font-size: 18px; margin-top: -10px; font-weight: 500; color: #B14F4B;">Tahun {{ $year }}</p>
                       ...
                       <div class="w-full d-flex justify-content-end align-items-center">
                        ...
                        @foreach($yearBalanceSheet['month_name'] as $monthIndex => $monthName)
                            <div style="margin-top: 30px; margin-bottom: 30px;">
                                <h3 style="font-weight: bold; color: #467FF7;">{{ $monthName }}</h3>
                                @php
                                    $balanceSheet = $yearBalanceSheet['data'][$monthIndex];
                                @endphp
                                <div class="row">
                                    <!-- Aktiva Column -->
                                    <div class="col-md-6">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                        ...
                                                        @if($accountGroup['header'])
                                                            <tr>
                                                                ...
                                                                <td style="text-align: right; font-weight: bold;">
                                                                    {{ number_format($accountGroup['header_balance'], 0, ',', '.') }}
                                                                </td>
                                                            </tr>
                                                ...
                                                <tr style="background-color: #597fb3">
                                                    ...
                                                    <th style="color: white; text-align: right; font-weight: bold;">
                                                        {{ number_format($balanceSheet['aktiva']['total'], 0, ',', '.') }}
                                                    </th>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr style="background-color: #597fb3">
                                                    ...
                                                    <th style="color: white; text-align: right; font-weight: bold;">
                                                        {{ number_format($balanceSheet['passiva']['total'], 0, ',', '.') }}
                                                    </th>
                                                </tr>
                                            </tbody>
                                        </table>
