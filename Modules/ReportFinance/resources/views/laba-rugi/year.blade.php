                ...
                <div class="row" style="background-color: white; padding-top: 50px; padding-bottom: 50px;" id="headerPrint">
                    <div class="col-xl-12">
                        ...
                        <div class="w-full" style="margin-bottom: 50px;">
                          ...
                          <div class="d-flex gap-5 flex-column" id="bottomPrint">
                            @foreach($yearProfitLoss["data"] as $idx => $data)
                            @if(count($data["pendapatan"]) > 0 || count($data["beban_operasional"]) > 0 || count($data["beban"]) > 0)
                            <div>
                              <h1 style="font-size: 18px; margin-top: -10px; font-weight: 500; color: #B14F4B;">{{ $yearProfitLoss["month_name"][$idx] }}</h1>
                            ...
                            @php
                                ...
                                $beban_operasional = $data["beban_operasional"];
                                $beban = $data["beban"];
                            @endphp
                            <!-- Pendapatan -->
