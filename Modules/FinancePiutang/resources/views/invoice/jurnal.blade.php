        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 style="color: #59758B; font-size: medium; font-size: 35px;">Journal Invoice</h1>
                </div>
                <!-- PAGE-HEADER END -->
                <div class="" style="margin-bottom: 50px;">
                    <table style="width: fit-content; margin-bottom: 50px;">
                        ...
                        <tr>
                            ...
                            <td style="padding: 10px; font-size: 18px;">:</td>
                            <td style="padding: 10px; font-size: 18px;">{{ \Carbon\Carbon::parse($data->date_invoice)->format('j F, Y') }}</td>
                        </tr>
                        <tr>
