                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="job_order" id="job_order"  placeholder="Link" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="no_transactions" class="form-label">Nomor Transaksi</label>
                                        <input type="text" name="no_transactions" id="no-transactions" class="form-control" readonly placeholder="Link" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="date_invoice" class="form-label">Date</label>
                                        <input type="date" class="form-control" name="date_invoice" id="date_invoice" onchange="updateDueDate()">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date_expired" id="date_expired">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sell_des" id="sell_des" placeholder="Desc" >
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <input type="text" style="width: 10%" class="form-control" id="discount" name="discount" value="0" onchange="hideButton()" />
                                                    <input type="text" style="width: 50%" class="form-control" id="discount_display" name="discount_display" value="0" readonly />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                ...
                success:function(response)
                {
                    ...
                    if(response.data?.sales?.details){
                        ...
                        response.data.sales.details.forEach(function(data) {
                            ...
                            <td>
                                <input type="text" class="form-control qty-input" name="qty_detail" onchange="calculate()" />
                                <label class="form-label">Disc</label>
                                <input type="text" class="form-control discount-input" name="disc_detail" onchange="calculate()" />
                            </td>
                            <td>
                                <input type="text" class="form-control uom-input" name="uom_detail" />
                                <label class="form-label" style="visibility: hidden;">Disc</label>
                                <select class="form-control select2 form-select discount-type" data-placeholder="Choose One" name="disc_type_detail" onchange="calculate()" >
                                    <option value="persen">%</option>
                                    <option value="nominal">0</option>
                                </select>
                            </td>
        ...
        document.getElementById('submit-all-form').addEventListener('click', function(event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    window.location.href = "{{ route('finance.piutang.invoice.index') }}";
                },
