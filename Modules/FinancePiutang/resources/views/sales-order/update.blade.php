...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        <form action="{{ route('finance.piutang.sales-order.update',  $dataSalesOrder->id) }}" method="POST" enctype="multipart/form-data" name="dynamic-form">
            @csrf
            @method('PUT')
            <!-- PAGE-HEADER -->
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date_sales" id="date_sales" value="{{ $dataSalesOrder->date }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="des_head_sales" id="des_head_sales" placeholder="Sales Order - No Transaksi" value="{{ $dataSalesOrder->description }}" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="custom-control custom-radio">
                                        <input type="checkbox" id="choose_job_order" name="choose_job_order" class="custom-control-input" value="{{ isset($dataSalesOrder->marketing) ? 1 : 0 }}" {{ isset($dataSalesOrder->marketing) ? "checked" : "" }}>
                                        <span class="custom-control-label"><b>Choose Job Order</b></span>
                                    </label>
                                </div>
                            </div>
                            <div style="{{ isset($dataSalesOrder->marketing) ? "" : "display:none;" }}" id="job_order_display">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 form-select"
                                                ...
                                                @foreach ($marketing as $m)
                                                    <option value="{{ $m->id }}:{{ $m->source }}"
                                                        @if(isset($dataSalesOrder->marketing))
                                                        @if($m->id === $dataSalesOrder->marketing->id && $m->source === $dataSalesOrder->marketing->source)
                                                            selected
                                                        @endif
                                                        @endif>{{ $m->quotation->quotation_no }} - {{ $m->source }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="job_order_id" id="job_order_id" readonly placeholder="Link" value="{{ isset($dataSalesOrder->marketing->job_order_id) ? $dataSalesOrder->marketing->job_order_id : "" }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="consignee" class="form-label">Consignee</label>
                                            <input type="text" class="form-control" name="consignee" id="consignee" readonly placeholder="Link" value="{{ isset($dataSalesOrder->marketing->consignee) ? $dataSalesOrder->marketing->consignee : "" }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            @php
                                                $transportation = '';
                                                if($dataSalesOrder->marketing) {
                                                    if($dataSalesOrder->marketing->transportation === 1) {
                                                        $transportation = 'Air Freight';
                                                    } else if($dataSalesOrder->marketing->transportation === 2) {
                                                        $transportation = 'Sea Freight';
                                                    } else if($dataSalesOrder->marketing->transportation === 3) {
                                        ...
                                        <label class="custom-control custom-radio" id="transportation_desc" style="{{ isset($dataSalesOrder->marketing->transportation_desc) ? "" : "display:none;" }}">
                                            <input type="radio" class="custom-control-input"
                                                name="transportation_desc" checked>
                                            <span class="custom-control-label">{{ isset($dataSalesOrder->marketing->transportation_desc) ? $dataSalesOrder->marketing->transportation_desc : "" }}</span>
                                        </label>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="shipper" class="form-label">Shipper</label>
                                            <input type="text" class="form-control" name="shipper" id="shipper" readonly placeholder="Link" value="{{ isset($dataSalesOrder->marketing->shipper) ? $dataSalesOrder->marketing->shipper : "" }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="commodity" class="form-label">Commodity</label>
                                            <input type="text" class="form-control" name="commodity" id="commodity" readonly placeholder="Link" value="{{ isset($dataSalesOrder->marketing->description) ? $dataSalesOrder->marketing->description : "" }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody id="form-container">
                                        ...
                                        @foreach ($dataSalesOrder->details as $data)
                                            <tr class="form-wrapper">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="qty_detail" value="{{ $data->quantity }}" onchange="calculate(); toUpdate(this)" />
                                                    <label class="form-label">Disc</label>
                                                    <input type="text" class="form-control" name="disc_detail" value="{{ $data->discount_nominal }}" onchange="calculate(); toUpdate(this)" />
                                                    </td>
                                                <td>
                                                    <input type="text" class="form-control" name="uom_detail" value="{{ $data->uom }}" onchange="toUpdate(this)" />
                                                    <label class="form-label" style="visibility: hidden;">Disc</label>
                                                    <select class="form-control select2 form-select" data-placeholder="Choose One" name="disc_type_detail" onchange="calculate(); toUpdate(this)">
                                                        @php
                                    ...
                                    <table class="table mt-5">
                                        {{-- <tr>
                                            <td>
                                                <div class="d-flex justify-content-between">
                                                    Biaya Lain
                                                    <input type="text" style="width: 50%" class="form-control" name="additional_cost" id="additional_cost" value="{{ number_format($dataSalesOrder->additional_cost, 2, '.',',') }}" />
                                                </div>
                                            </td>
                                        </tr> --}}
                                        <tr>
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div style="width: 10%">
                                                        <select class="form-control select2 form-select" name="discount_type" id="discount_type" onchange="hideButton()">
                                                            <option value="persen" {{ $dataSalesOrder->discount_type === "persen" ? "selected" : "" }}>%</option>
                                                            <option value="nominal" {{ $dataSalesOrder->discount_type === "nominal" ? "selected" : "" }}>0</option>
                                                        </select>
                                                    </div>
                                                    <input type="text" style="width: 10%" class="form-control" name="discount" id="discount" onchange="hideButton()" value="{{ $dataSalesOrder->discount_nominal }}"/>
...
@push('scripts')
    ...
    <script>
        ...
        function getJobOrder() {
            ...
            const selectElement = document.getElementById("no_referensi");
            selectElement.innerHTML = ""
            const job_order_id = document.getElementById("job_order_id")
            job_order_id.value = "";
        ...
        document.getElementById('add-form').addEventListener('click', function() {
            ...
            <td>
                <input type="text" class="form-control total-input" name="total_detail" value="0" readonly />
            </td>
            <td>
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn delete-row" onclick="deleteList(this)"><i class="fa fa-trash text-danger delete-form"></i></button>
            ...
            $.ajax({
                ...
                success:function(response)
                {
                    if(response.message === "Success") {
                        const current_year = '{{ \Carbon\Carbon::parse($dataSalesOrder->date)->year }}'
                        let number = '{{ $dataSalesOrder->number }}'
                        ...
                        $('#no-transaction').val(`SO-PIL${year}-${month}-${number}`)
                    }
                }
            })
        })
