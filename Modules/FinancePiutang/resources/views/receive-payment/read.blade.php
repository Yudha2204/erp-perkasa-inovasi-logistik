                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex d-inline">
                                            <select class="form-control select2 form-select"
                                                ...
                                                <option value="{{ $data_recieve->contact->id }}">{{ $data_recieve->contact->customer_name }}</option>   
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 form-select"
                                            ...
                                            <option value="{{ $data_recieve->account->id }}">{{ $data_recieve->account->account_name }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date_recieve" id="date_recieve" value="{{ $data_recieve->date_recieve }}" readonly >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 form-select"
                                            ...
                                            <option value="{{ $data_recieve->currency_id }}">{{ $data_recieve->currency->initial }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="description" id="description" value="{{ $data_recieve->description }}" placeholder="Desc" readonly >
                                    </div>
                                </div>
                            </div>
                            @if(isset($data_recieve->job_order))
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 form-select"
                                                ...
                                                <option value="{{ $data_recieve->job_order_id }}:{{ $data_recieve->source }}">{{ $data_recieve->job_order->job_order_id }} - {{ $data_recieve->source }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex justify-content-between gap-2">
                                                    ...
                                                    <select class="form-control select2 form-select" data-placeholder="X" name="other_currency_type" disabled>
                                                        @php
                                                            $name = "";
                                                            if($data->currency_via->from_currency_id === $data_recieve->currency_id) {
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="note_recieve" id="note_recieve" cols="30" rows="5" readonly placeholder="Tulis catatan transaksi di sini ( maks 1000 karakter )" class="form-control">{{ $data_recieve->note }}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center">
                                                    Biaya Lain
                                                    <input type="text" style="width: 50%" class="form-control" name="additional_cost" id="additional_cost" placeholder="0" value="{{ number_format($data_recieve->additional_cost,2,'.',',') }}" readonly />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
