...
class ReceivePaymentController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $terms = MasterTermOfPayment::all();
        $currencies = MasterCurrency::all();
        $accounts = MasterAccount::where('master_currency_id', $data_recieve->currency_id)->get();
        $accountTypes = AccountType::all();
        ...
        return view('financepiutang::receive-payment.update', compact('contact', 'terms', 'currencies', 'accounts', 'accountTypes', 'data_recieve','marketing','invoices','exchange'));
    }
