...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payment_detail', function (Blueprint $table) {
            $table->id();
            $table->foreignId('head_id')->nullable()->constrained("payment_head")->cascadeOnUpdate()->nullOnDelete();
            $table->foreignId('payable_id')->nullable()->constrained("account_payable_head")->cascadeOnUpdate()->nullOnDelete();
