...
return new class extends Migration
{
    ...
    {
        Schema::create('kas_in_head', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('date_kas_in')->nullable();
            $table->foreignId('transaction_id')->nullable()->constrained("no_transaction_kas_in")->cascadeOnUpdate()->nullOnDelete();  
    ...
    {
        Schema::dropIfExists('kas_in_head');
    }
};
