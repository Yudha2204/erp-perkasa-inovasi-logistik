...
class AccountTypeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $array_simple = [
            ...
            ["1", "1-0003", "Current Asset", "0", "0", "debit", "BS"], // 2
            ["1", "1-0004", "Account Receivable", "0", "0", "debit", "BS"], // 2
            ["1", "1-0005", "Fixed Asset", "0", "0", "debit", "BS"], // 2

            ["2", "2-0001", "Account Payable", "0", "0", "credit", "BS"], // 2
            ["2", "2-0002", "Other Payable", "0", "0", "credit", "BS"], // 2

            ["3", "3-0001", "Equity", "0", "0", "credit", "BS"], // 2
            ["3", "3-0002", "Current Earning", "0", "0", "credit", "BS"], // 2
            ["3", "3-0003", "Retained Earning", "0", "0", "credit", "BS"], // 2
            
            ["4", "4-0000", "Income", "0", "0", "credit", "PL"], // 2
            ["5", "5-0000", "Cost of Sales", "0", "0", "debit", "PL"], // 2
            ["6", "6-0000", "Expense", "0", "0", "debit", "PL"], // 2
            ["7", "7-0000", "Other Income", "0", "0", "credit", "PL"], // 2
            ["8", "8-0000", "Other Expense", "0", "0", "debit", "PL"], // 2

            ["9", "9-0001", "Rounding Difference", "0", "0", "credit", "PL"], // 2
            ["9", "9-0002", "Exchange Profit/Loss", "0", "0", "credit", "PL"], // 2
            ["9", "9-9999", "Profit Loss Summary", "0", "0", "debit", "NONE"], // 2
        ];
