...
class MarketingImportSeeder extends Seeder
{
    ...
    {
        $array_simple = [
            ["1", "JOPILBTH-00001", "1", "2", "FCL", "0001", "Import gula tebu", "9999", "200", "ini volumenya", "M3", "Batam", "Ex Shanghai", "Jl. Tambunan", "Jakarta", "Express", "Jl. Mataram", "-", "1"],
            ["2", "JOPILBTH-00002", "1", "2", "LCL", "0002", "Import Minyak Sawit", "9990", "300", "ini volumenya", "M3", "Riau", "Ex Shanghai", "Jl. Srikaya", "Papua", "Express JS", "Jl. Apel", "-", "2"],
        ];

        //insert to marketing_import table
        for ($i=0; $i < 2; $i++) { 
            DB::table('marketing_import')->insert([
        ...
        //insert to dimension_marketing_import table
        $array_dimension = [
            ["1", "1", "12", "13", "14", "2", "10"],
            ["1", "2", "7", "8", "9", "3", "11"],
            ["2", "1", "12", "13", "14", "2", "10"],
        ...
        for ($i=0; $i < 4; $i++) { 
            DB::table('dimension_marketing_import')->insert([
                'marketing_import_id' => $array_dimension[$i][0],
        ...
        //insert to quotation_marketing_import table
        $array_quotation = [
            ["1", "99898", "-", "1"],
            ["2", "90000", "-", "1"],
        ];
        ...
        for ($i=0; $i < 2; $i++) { 
            DB::table('quotation_marketing_import')->insert([
                'marketing_import_id' => $array_quotation[$i][0],
        ...
        //insert to group_quotation_marketing_import table
        $array_group = [
            ["1", "A"],
            ["2", "A"],
        ];
        ...
        for ($i=0; $i < 2; $i++) { 
            DB::table('group_quotation_m_im')->insert([
                'quotation_m_im_id' => $array_group[$i][0],
                'group' => $array_group[$i][1],
                'created_at' => Carbon::now()->format('Y-m-d H:i:s')
            ]);
        }

        //insert to item_group_quotation_marketing_import table
        $array_group = [
            ["1", "Barang 1", "1000000", "-"],
            ["1", "Barang 2", "2000000", "-"],
            ["2", "Barang 1", "1000000", "-"],
        ...
        for ($i=0; $i < 4; $i++) { 
            DB::table('item_group_quotation_m_im')->insert([
                'group_quotation_m_im_id' => $array_group[$i][0],
